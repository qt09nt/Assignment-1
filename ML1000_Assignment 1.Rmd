...
cat("First, Let's fit a random forset model.")
#random forest
...
cat("Then let's try a knn model.")
#knn
...
cat("Next, let's try a glm model.")
#glm
...
cat("Finally, let's try regularized logistic regression.")
#logreg
