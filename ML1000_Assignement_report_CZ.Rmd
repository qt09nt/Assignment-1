...
X=subset(X, select = -c(capital_gain, capital_loss,hours_per_week,native_country))
...
First, for the simplicity in coding, let's recode the values of target variable to be "Y", meaning yearly income is higher than 50K USA, and "N", indicating the income is no more than 50K.  
